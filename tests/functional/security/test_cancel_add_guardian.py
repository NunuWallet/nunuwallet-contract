...
def test_cancel_add_guardian(bob, w3, proxy, base, security, new_account, base_sign_message):
    ...
    # cancel guardian addtion
    # only self/owner call
    data = security.cancel_guardian_addition.encode_input(new_account, new_guardian1)
