...
@pytest.fixture
def nunu_account(project, bob):
    return bob.deploy(project.NunuAccount)
...
@pytest.fixture
def factory(project, bob, nunu_account, signature_checker, security):
    return bob.deploy(project.NunuFactory, nunu_account, bob, signature_checker, security)
...
def base_sign_message():
    def base_sign_message(
        ...
        msg = {
            "domain": {
                "name": 'Nunu Wallet Base Manager v1',
                "version": 'v1.0.0',
